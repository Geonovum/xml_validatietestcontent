...
<geo:GeoInformatieObjectVaststelling xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0"
   ...
   <geo:vastgesteldeVersie>
      <geo:GeoInformatieObjectVersie><!-- FOUT LVBB 3509 Alle aanleverde io(s) moeten voorkomen in het besluit -->
         ...
         <geo:locaties>
            <geo:Locatie>
               ...
               <geo:geometrie>
                  <basisgeo:Geometrie gml:id="i9-df90920d-0ff0-4da0-f6d9-ffcf9a9f46f0-xx">
                     <basisgeo:id>df90920d-0ff0-4da0-f6d9-ffcf9a9f46f0</basisgeo:id>
                     <basisgeo:geometrie>
                        <gml:MultiSurface gml:id="i9-df90920d-0ff0-4da0-f6d9-ffcf9a9f46f0"
