...
<geo:GeoInformatieObjectVaststelling xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0"
   ...
   <geo:vastgesteldeVersie>
      <geo:GeoInformatieObjectVersie>
         ...
         <!-- FOUT STOPIn een GIO waar locaties geen kwalitatieve of kwantitatieve normwaarde hebben, MOGEN eenheidID, eenheidlabel, normID en normlabel NIET voorkomen. -->
