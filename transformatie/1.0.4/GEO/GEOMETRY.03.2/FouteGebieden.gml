...
<geo:GeoInformatieObjectVaststelling xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0"
   ...
   <geo:vastgesteldeVersie>
      <geo:GeoInformatieObjectVersie>
         ...
         <geo:locaties>
            <geo:Locatie>
               <geo:naam>GEOMETRIE.03.2</geo:naam>
               <geo:geometrie>
                     ...
                     <basisgeo:geometrie>
                        <gml:MultiSurface gml:id="ib-abbabadb-abbb-adbb-aaad-bbaadbdbbbba"
                           ...
                           <gml:surfaceMember>
                              <gml:Polygon>
                                 <gml:exterior>
                                    <gml:LinearRing><!-- FOUT GEO METRY_03_2	geometrie is ongeldig (zie functionele documentatie op: https://aandeslagmetdeomgevingswet.nl/ontwikkelaarsportaal/api-register/api/geo-validatieservice/) -->
