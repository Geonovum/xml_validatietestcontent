...
<geo:GeoInformatieObjectVaststelling xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0"
   ...
   <geo:vastgesteldeVersie>
      <geo:GeoInformatieObjectVersie>
         ...
         <!-- FOUT: LVBB2017	Een AKN- of JOIN-identificatie mag geen punt bevatten -->
         <geo:FRBRExpression>/join/i.d/regdata/gm0297/2019/GoedeGebieden-LVBB2017/nld@2019-06-18;3520</geo:FRBRExpression>
         ...
         <geo:locaties>
            <geo:Locatie>
               ...
               <geo:geometrie>
                  <basisgeo:Geometrie gml:id="i2-a6292256-52e2-2695-5765-722662286a6a-xx">
                     <basisgeo:id>a6292256-52e2-2695-5765-722662286a6a</basisgeo:id>
                     <basisgeo:geometrie>
                        <gml:MultiSurface gml:id="i2-a6292256-52e2-2695-5765-722662286a6a"
